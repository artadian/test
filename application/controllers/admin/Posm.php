...
class Posm extends CI_Controller {
    ...
    public function list_posm(){
        ...
        $data['main_content'] = $this->load->view('admin/posm/v_posm', $data, TRUE);		
        $this->load->view('admin/index', $data);
    }

	public function get_list_posm()
    {
