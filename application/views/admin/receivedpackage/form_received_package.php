                    ...
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                                            ...
                                            <table id="tblDokumen" class="table table-striped">
                                                ...
                                                <tbody>                               
                                                	...
                                                	<tr>
                                                        ...
                                                        <td>
															<?php if ($detail[$i]["IsStop"] == '1') { ?>
                                                            <div class="label label-table label-danger">STOP</div>
                                                            <?php } else if ($detail[$i]["Status"] == 'COMPLETE') { ?>                                                            <div class="label label-table label-success">OK</div>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                	<?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                	<?php if ($header['JumStop'] == 0) { ?>
                                	<button id="btnCancel" class="btn btn-block btn-info btn-rounded">CANCEL</button>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
 ...
 <script type="text/javascript">
 	$(document).ready(function(){	
		...
		$("#btnBack").click(function() {						
			location.href="<?php echo base_url();?>admin/receivedpackage/received_package";				
		});		 	
		...
		$("#btnCancel").click(function() {	
			...
			function(){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/receivedpackage/cancel",
