...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Received Package </h3>
 ...
 <script type="text/javascript">
 	$(document).ready(function(){	
		...
		var table = $('#tblDokumen').DataTable({
			"pageLength" : 10,
			"ajax": {
				url : "<?php echo base_url();?>admin/receivedpackage/get_list_received",
				type : 'POST'
			},
			'columnDefs': [
			  {
		...
		$('#tblDokumen tbody').on('click', 'button', function () {
			...
			location.href="<?php echo base_url();?>admin/receivedpackage/edit_received_package/" + data[0];		
		});
