...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">List On Going Package </h3>
...
<div class="row">
    ...
    <div class="col-sm-2">
        <button id="btnReceive" class="btn btn-block btn-success btn-rounded">RECEIVE PACKAGE</button>
    </div>              		
    <div class="col-sm-5"></div>
</div>
 ...
 <script type="text/javascript">
 	$(document).ready(function(){	
		...
		var table = $('#tblDokumen').DataTable({
			"pageLength" : 10,
			"ajax": {
				url : "<?php echo base_url();?>admin/ongoingpackage/get_list",
				type : 'POST'
			},
			'columnDefs': [
			  {
		...
		$('#btnReceive').on('click', function(e){	
			...
			if (idcheck.length > 0)
			{
				...
				function(){
					...
					$.ajax({
						type: "POST",
						url: "<?php echo base_url();?>admin/ongoingpackage/receive_package",
			...
			{
				swal('Warning','Please choose package to be received','warning');
				return false;
			}
	   	});	
