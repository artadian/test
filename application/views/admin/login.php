...
$system_name = "RIGID MAJU BERSAMA";
$system_title = "RIGID MAJU BERSAMA";
?>
<!DOCTYPE html>  
<html lang="en">
<head>
...
<meta name="description" content="Wismilak-IT">
<meta name="author" content="Wismilak-IT">
        <link rel="icon" href="<?php echo base_url(); ?>optimum/title2.png" type="image/x-icon" />
...
<section id="wrapper" class="login-register" >
  <div class="login-box login-sidebar">
    <div class="white-box"> 
               <div align="left"> 
				<br><br><br>
				<img width="360" height="150" src="<?php echo base_url(); ?>optimum/logo.png">                 
                <div align="center">
                       <?php if (isset($page) && $page == "logout"): ?>
                    <div class="alert alert-warning hide_msg pull" style="width: 100%"> <i class="fa fa-check-circle"></i> Logout Successfully &nbsp;
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                    </div>
                    <?php elseif(isset($page) && $page == "wrong"): ?>
                        <div class="alert alert-danger hide_msg pull" style="width: 100%"> <i class="fa fa-check-circle"></i> Wrong User / Password &nbsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
               	 	<?php endif ?>
                    </div>
		<br><br>
					...
					<div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                            <input class="form-control" type="text" name="user_name" value="" required="" placeholder="Username" style="width:100%">
                                    </div>
                                </div>
       <div class="form-group ">
                        <div class="col-xs-12">
