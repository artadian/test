...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Send Package </h3>
 ...
 <script type="text/javascript">
 	$(document).ready(function(){	
		...
		var table = $('#tblDokumen').DataTable({
			"pageLength" : 10,
			"ajax": {
				url : "<?php echo base_url();?>admin/sendpackage/get_list_send",
				type : 'POST'
			},
			'columnDefs': [
			  {
		...
		$('#tblDokumen tbody').on('click', 'button', function () {
			...
			location.href="<?php echo base_url();?>admin/sendpackage/edit_send_package/" + data[0];		
		});
