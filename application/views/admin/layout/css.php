...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>optimum/title2.png">
    ...
    <link href="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/buttons.dataTables.min.css" rel="stylesheet" type="text/css" />
