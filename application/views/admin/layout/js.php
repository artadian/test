...
<script>
 ...
 <!-- Calendar JavaScript -->
    ...
    <!--<script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/dataTables.checkboxes.min.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/dataTables.checkboxes.css" />-->
    
    <!-- start - This is for export functionality only -->
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/dataTables.buttons.min.js"></script>
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/buttons.flash.min.js"></script>
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/jszip.min.js"></script>
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/pdfmake.min.js"></script>
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/vfs_fonts.js"></script>
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/buttons.html5.min.js"></script>
    <script src="<?php echo base_url(); ?>optimum/plugins/bower_components/datatables/buttons.print.min.js"></script>
...
<script src="<?php echo base_url(); ?>optimum/js/jquery.json.min.js"></script>

<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>optimum/css/ProgressIndicator.css" />
	
<script src="<?php echo base_url(); ?>optimum/js/xlsx.core.min.js"></script>
<script src="<?php echo base_url(); ?>optimum/js/xls.core.min.js"></script>
