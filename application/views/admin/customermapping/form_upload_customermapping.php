					 ...
					 reader.onload = function (e) {  
						 ...
						 if (exceljson.length > 0 && cnt == 0) {  						 	 
							 ...
							 for (var i = 0; i < exceljson.length; i++) { 									   
								...
								var cellValueDay = exceljson[i]['Day'];  										 
								if (cellValueDay == null)  
									cellValueDay = "";

								var cellValueWeek = exceljson[i]['Week'];  										 
								if (cellValueWeek == null)  
									cellValueWeek = "";

								var cellValueCustomerno = exceljson[i]['Customerno'];
								if (cellValueCustomerno == null)  										 									 
									cellValueCustomerno = "";

								var cellValueUrut = exceljson[i]['Urut'];  										 
								if (cellValueUrut == null)  
									cellValueUrut = "";

								TableData[i]={
									"Salesman" : cellValueSalesman.trim()
									, "Day" : cellValueDay.trim()
									, "Week" : cellValueWeek.trim()
									, "Customerno" : cellValueCustomerno.trim()
									, "Urut" : cellValueUrut.trim()
								}    									
							 ...
							 $.ajax({
								type: "POST",
								url: "<?php echo base_url();?>admin/customermapping/upload",
